...
public class ListaArray {
	...
	public static void main(String[] args) {
		...
		// número de elementos da agenda:métod size()
		...
		try {
			...
			// exceção lançda para indicar que um indice (i)
			// está fora do intervalo vlido (de o atégenda.s()-1)
			System.out.printf("\nErro: posíção inválida (%s).",
					e.getMessage());
		}
